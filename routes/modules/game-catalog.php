...
Route::middleware(['web', 'public.locale'])->group(function (): void {
    ...
    Route::get('/wiki/creatures', [PublicGameCatalogController::class, 'creatures'])
        ->defaults('locale', 'en')
        ->name('legacy.game-catalog.creatures.index');

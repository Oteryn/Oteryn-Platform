...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: ['**/portability-critical.spec.mjs', '**/public-wiki*.spec.mjs', '**/admin-wiki*.spec.mjs'],
      use: {
        browserName: 'chromium',
        viewport: desktopViewport,
      },
    ...
    },
    {
      ...
      testMatch: ['**/responsive-critical.spec.mjs', '**/public-wiki*.spec.mjs', '**/admin-wiki*.spec.mjs'],
      use: {
        browserName: 'chromium',
        viewport: desktopViewport,
      },

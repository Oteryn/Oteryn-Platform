...
return [
    'header' => [
        ...
        ['label' => 'public.editorial.labels.support', 'route' => 'support.index', 'active' => 'support.*', 'priority' => 70],
    ],
    'footer' => [
        [
            'key' => 'learn',
        ...
        [
            ...
            'priority' => 40,
            'items' => [
                ['label' => 'public.editorial.labels.support', 'route' => 'support.index', 'active' => 'support.index', 'priority' => 10],

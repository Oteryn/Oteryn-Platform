...
return [
    'header' => [
        ...
        ['label' => 'support.nav.support_center', 'route' => 'support.index', 'active' => 'support.*', 'priority' => 70],
    ],
    'footer' => [
        [
            'key' => 'learn',
        ...
        [
            ...
            'priority' => 40,
            'items' => [
                ['label' => 'support.nav.support_center', 'route' => 'support.index', 'active' => 'support.index', 'priority' => 10],

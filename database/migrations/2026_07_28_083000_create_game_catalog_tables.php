...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('game_catalog_snapshots', function (Blueprint $table): void {
            ...
            $table->string('schema_version', 24);
            ...
            $table->foreignId('runtime_release_id')->constrained('game_catalog_releases');
            $table->foreignId('content_target_release_id')->constrained('game_catalog_releases');
            $table->foreignId('verified_content_through_release_id')->constrained('game_catalog_releases');
            $table->foreignId('contains_content_through_release_id')->nullable()->constrained('game_catalog_releases');
        ...
        Schema::create('game_catalog_profiles', function (Blueprint $table): void {
            ...
            $table->foreignId('target_release_id')->constrained('game_catalog_releases');
            $table->foreignId('active_snapshot_id')->nullable()->constrained('game_catalog_snapshots');
        ...
        Schema::create('game_catalog_entities', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['entity_type', 'canonical_key'], 'catalog_entity_type_key_unique');
        });
        ...
        Schema::create('game_catalog_entity_snapshots', function (Blueprint $table): void {
            ...
            $table->foreignId('entity_id')->constrained('game_catalog_entities');
            $table->foreignId('introduced_release_id')->nullable()->constrained('game_catalog_releases');
            $table->foreignId('removed_release_id')->nullable()->constrained('game_catalog_releases');
            ...
            $table->timestamps();
            $table->unique(['snapshot_id', 'entity_id'], 'catalog_snapshot_entity_unique');
            $table->index(['snapshot_id', 'completeness', 'availability'], 'catalog_entity_visibility_lookup');
        });
        ...
        Schema::create('game_catalog_entity_identifiers', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['entity_snapshot_id', 'namespace', 'value'], 'catalog_entity_identifier_unique');
            $table->index(['namespace', 'value'], 'catalog_identifier_lookup');
        });
        ...
        Schema::create('game_catalog_item_snapshots', function (Blueprint $table): void {
            ...
            $table->index(['name', 'minimum_level'], 'catalog_item_name_level');
        });
        ...
        Schema::create('game_catalog_creature_snapshots', function (Blueprint $table): void {
            ...
            $table->decimal('mitigation', 10, 4)->nullable();
        ...
        Schema::create('game_catalog_relation_snapshots', function (Blueprint $table): void {
            ...
            $table->foreignId('source_entity_id')->constrained('game_catalog_entities');
            $table->foreignId('target_entity_id')->nullable()->constrained('game_catalog_entities');
            $table->foreignId('introduced_release_id')->nullable()->constrained('game_catalog_releases');
            $table->foreignId('removed_release_id')->nullable()->constrained('game_catalog_releases');
            $table->string('completeness', 32);
            $table->boolean('enabled');
            ...
            $table->timestamps();
            $table->unique(['snapshot_id', 'relation_type', 'canonical_key'], 'catalog_snapshot_relation_unique');
            $table->index(['snapshot_id', 'relation_type'], 'catalog_relation_type_lookup');
        });
        ...
        Schema::create('game_catalog_import_runs', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('snapshot_id')->nullable()->constrained('game_catalog_snapshots');
        ...
        Schema::create('game_catalog_validation_findings', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('import_run_id')->constrained('game_catalog_import_runs')->cascadeOnDelete();
        ...
        Schema::create('game_catalog_profile_entities', function (Blueprint $table): void {
            ...
            $table->dateTimeTz('computed_at');
            $table->primary(['profile_id', 'entity_snapshot_id'], 'catalog_profile_entity_primary');
        });
        ...
        Schema::create('game_catalog_profile_relations', function (Blueprint $table): void {
            ...
            $table->string('reason_code', 40);
            $table->dateTimeTz('computed_at');
            $table->primary(['profile_id', 'relation_snapshot_id'], 'catalog_profile_relation_primary');
        });
        ...
        Schema::create('game_catalog_entity_translations', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['entity_id', 'locale'], 'catalog_entity_locale_unique');
            $table->unique(['locale', 'slug'], 'catalog_locale_slug_unique');
        });
        ...
        Schema::create('game_catalog_wiki_links', function (Blueprint $table): void {
            ...
            $table->primary(['entity_id', 'wiki_article_id', 'link_type'], 'catalog_wiki_link_primary');
        });
        ...
        Schema::create('game_catalog_profile_overrides', function (Blueprint $table): void {
            ...
            $table->unsignedBigInteger('approved_by_identity_id')->nullable();
            $table->dateTimeTz('approved_at');
            $table->timestamps();
            $table->index(['profile_id', 'action']);
        });

        Schema::create('game_catalog_activation_history', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('profile_id')->constrained('game_catalog_profiles')->cascadeOnDelete();
            $table->foreignId('from_snapshot_id')->nullable()->constrained('game_catalog_snapshots');
            $table->foreignId('to_snapshot_id')->constrained('game_catalog_snapshots');
    ...
    {
        Schema::dropIfExists('game_catalog_activation_history');

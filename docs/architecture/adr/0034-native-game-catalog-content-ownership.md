...
3. **Legacy Canary Compatibility importers remain anti-corruption adapters.** Canary schemas `1.0.0`–`1.3.0`, numeric/runtime identifiers and final-registry assumptions remain scoped to compatibility snapshots. They cannot define native canonical identity, native schema evolution or native producer capability.

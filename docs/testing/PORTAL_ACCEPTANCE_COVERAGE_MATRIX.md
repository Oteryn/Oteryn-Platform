...
| Announcements | `covered` | none-active/active/expired/future/draft-hidden/escaped; EN/PL isolation; guest/no-MFA/no-permission/exact manager; validation/create/publish/stale recovery/conflict/audit; Chromium D/T/M and public Firefox/WebKit | None in current contract |

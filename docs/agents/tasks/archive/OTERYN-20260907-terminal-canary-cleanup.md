...
- [x] Exact-head checks pass without controller or policy changes.
- [x] Protected-main apply evidence proves guarded deletion and live absence.
...
owned_paths:
  ...
  - docs/agents/tasks/archive/OTERYN-20260907-terminal-canary-cleanup.md
  - docs/agents/TERMINAL_BRANCH_DELETION_APPROVAL.json -> deleted after one-shot apply
modules:
  - agent-governance
dependencies:
  - Oteryn/Oteryn#142
...
head: f3ded5cb400e1a44cc1649549994f4cf890085a3
branch: governance/terminal-canary-cleanup-closeout-1305
pr: none
status: completed
context_routes:
  - agent-governance
owned_paths:
  ...
  - docs/agents/TERMINAL_BRANCH_DELETION_APPROVAL.json -> deleted after one-shot apply
proven:
  - Before guarded apply, PR #1290 was closed unmerged and its must-not-merge canary ref existed at d866d21ca856b925a32a3a5457174906237db199.
  - Before guarded apply, PR #1291 was closed unmerged and its must-not-merge canary ref existed at 65126f2b1d24e0fe497e436be99f524104021033.
  ...
  - Before guarded apply, PR #1270 was closed unmerged at exact branch head c2edd9f98fdad7496c79c6c2534251549ce577c7 and was explicitly superseded by merged adoption #1304.
  ...
  - Exact PR #1306 head 5e5843f419bf0427894e791e6b6a510b7f06cac2 passed Terminal Branch Lifecycle run 34110960469, CI run 34110960281 and Agent Governance run 34110961154 before protected integration.
  - PR #1306 merged normally as protected main f3ded5cb400e1a44cc1649549994f4cf890085a3; main Terminal Branch Lifecycle run 34111160408 apply job 101707594801 rebuilt and validated all three candidates, applied the reviewed manifest and published artifact 10014423932.
  - Live exact-ref readback after apply returns no refs for #1270, #1290 or #1291 targets; the #1306 source ref is also absent.
derived:
...
changed_paths:
  ...
  - docs/agents/tasks/active/OTERYN-20260907-terminal-canary-cleanup.md -> docs/agents/tasks/archive/OTERYN-20260907-terminal-canary-cleanup.md
  - docs/agents/TERMINAL_BRANCH_DELETION_APPROVAL.json -> deleted after one-shot apply
validation:
  ...
  - command: Terminal Branch Lifecycle run 34111160408 apply-reviewed-manifest job 101707594801
    result: PASS
    evidence: Fresh inventory and canonical approval validated three candidates; apply completed and artifact 10014423932 preserves manifest, deletion and recovery evidence. Subsequent exact-ref readback is absent for all three targets.
...
source_branch_reason: Dedicated same-repository cleanup branch; ordinary delete-after-merge applied after guarded target deletion.
source_branch_evidence: PR #1306 head 5e5843f419bf0427894e791e6b6a510b7f06cac2 merged as protected main f3ded5cb400e1a44cc1649549994f4cf890085a3; live source-ref readback is absent.
```

...
- When changing a task record, use `TASK_TEMPLATE.md`, `GOVERNANCE_CONTRACT.json` and the live governing Issue/PR. Never leave a terminal PR represented as active without the contract's explicit archive-pending transition.

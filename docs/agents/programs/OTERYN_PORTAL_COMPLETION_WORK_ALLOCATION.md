...
- PR #1028 is merged terminal; its Session Analyzer v1 task is archived in this package and releases active ownership. PlayerCompanion follow-up tools remain separately owned work.

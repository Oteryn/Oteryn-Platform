...
- Issue #490 is intentionally split by concern: Platform API, OperationsObservability/repository readiness and PublicEdge live proof have separate rows and may have different readiness/authority states. OperationsObservability repository/staging applicability is architecture-ready through `OPERATIONS_OBSERVABILITY_ARCHITECTURE.md`; direct production evidence remains a separate protected-environment gate.

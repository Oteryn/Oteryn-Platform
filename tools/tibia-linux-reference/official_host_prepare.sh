...
# This account is deliberately not placed in sudo/admin groups. Network namespace
# privilege, if needed, must be solved separately and narrowly after preflight.
...
printf '{"result":"PASS","host_profile":"ubuntu-systemd","dedicated_user":"%s","packages_installed":true,"evidence_volume_configured":false}\n' "$user"
